...
This validator detects toxic language in LLM-generated text using an LLM as the detection backbone (via [LiteLLM](https://docs.litellm.ai/)). It is a clean, LLM-based alternative to the model-based [ToxicLanguage](https://github.com/guardrails-ai/guardrails-hub-monorepo/tree/main/toxic_language/py) validator, which relies on the Detoxify `toxic-bert` model.
