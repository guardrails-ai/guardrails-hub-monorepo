...
@register_validator(name="guardrails/presidio_gliner_pii", data_type="string")
class PresidioGlinerPII(Validator):
    def __init__(
        self,
        entities: List[str],
        ...
        **Key Properties**
        ...
        | ----------------------------- | ----------------------------------- |
        | Name for `format` attribute   | `guardrails/presidio_gliner_pii`    |
