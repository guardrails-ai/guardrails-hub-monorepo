...
### Intended Use
This validator is designed to detect and anonymize Personally Identifiable Information (PII) in LLM-generated text using a combination of Presidio and GLiNER. It supports various entity types and can be configured to focus on specific PII categories.
...
# Setup Guard
guard = Guard().use(
    PresidioGlinerPII(entities=["DATE_TIME"], on_fail="fix")
)
...
<ul>
Initializes a new instance of the PresidioGlinerPII class.
